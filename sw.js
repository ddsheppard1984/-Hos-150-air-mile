const CACHE='hos150-app-v31-6';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./style.css','./pwa-v25.js','./trucknav-v28.js','./nav-saved-locations-v23.js','./customer-routing-v31.js','./v31-brand-fix.js','./app-icon.svg'];
