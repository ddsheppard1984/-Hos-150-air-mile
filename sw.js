const CACHE='hos150-app-v27-1';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./style.css','./pwa-v25.js','./trucknav-v27.js','./nav-saved-locations-v23.js','./app-icon.svg'];
