const CACHE='hos150-app-v32-0';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./style.css','./theme-future-v1.css','./pwa-v25.js','./trucknav-v28.js','./nav-saved-locations-v23.js','./customer-routing-v31.js','./customer-intel-v32.js','./v31-brand-fix.js','./app-icon.svg'];
