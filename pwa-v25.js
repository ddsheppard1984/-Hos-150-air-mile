...
function brand(){
  ...
  if(d)d.content='HOS, truck navigation, GPS, trip planning, weather, driver tools, customer intelligence, contact import and 150-air-mile companion for professional drivers.';
...
function loadCustomerEnhancements(){if(document.querySelector('script[data-customer-v30]'))return;const s=document.createElement('script');s.src='customer-place-enhancements-v30.js?v=31.0';s.dataset.customerV30='1';document.body.appendChild(s)}
...
function loadCopilot(){if(document.querySelector('script[data-driver-v31]'))return;const s=document.createElement('script');s.src='driver-copilot-v31.js?v=31.0';s.dataset.driverV31='1';document.body.appendChild(s)}
...
function boot(){brand();sw();loadCustomerEnhancements();loadTools();loadCopilot()}
